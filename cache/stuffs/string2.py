...
button1 = [
    [
        InlineKeyboardButton(text="Updates", url=f"https://t.me/IMPERIAL_ARENA"),
    ...
    [
        ...
        InlineKeyboardButton(text="Master✨", callback_data="repo_k"),
    ],                
    [                    
...
button3 = [
    [
        InlineKeyboardButton(text="Source", url="https://t.me/Dushmanxronin"),
        InlineKeyboardButton(text="Back", callback_data="HOME"),
    ],
]
